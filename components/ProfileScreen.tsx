    ...
    <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-6 sm:p-8 space-y-6 animate-slide-in-fade-in w-full max-w-md max-h-[90vh] overflow-y-auto">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <StatCard label={t('current_streak') as string} value={userStats.currentStreak} icon={<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24"><path d="M17.6 3.2C15.9 2.1 13.9 1.8 12 2.2c-.3.1-.6.2-.9.4-.9.4-1.8.9-2.6 1.6-2.1 1.8-3.3 4.4-3.5 7.2-.1 1.2-.1 2.5.1 3.7.2 1.3.6 2.5 1.2 3.7.1.2.2.4.3.5 1.5 2.8 4.3 4.5 7.4 4.7 1.1.1 2.2.1 3.2-.1 3.3-.5 6-2.6 7.2-5.5.5-1.2.7-2.4.7-3.6.1-1.4 0-2.8-.3-4.1-.1-.6-.3-1.2-.5-1.7-1.1-2.9-3.2-5.2-6-6.6zm-1 15.2c-1.3 1.8-3.4 2.8-5.7 2.8-1.4 0-2.7-.4-3.9-1.2-1.8-1.2-3-3.1-3.3-5.3-.2-1.2-.2-2.3 0-3.5.3-2.3 1.5-4.4 3.4-5.9 1.1-.9 2.3-1.5 3.7-1.8 1.4-.3 2.9-.1 4.2.5 2.3 1.1 4 3 4.8 5.4.3 1 .5 2 .5 3.1 0 1.1-.2 2.2-.5 3.2-.6 2-1.9 3.7-3.7 4.7z" /><path d="M11.5 8.9c0-.2.1-.4.1-.6.3-1.1 1.3-1.9 2.5-1.9 1.4 0 2.5 1.1 2.5 2.5s-1.1 2.5-2.5 2.5c-.3 0-.7-.1-1-.2-.5-.2-1-.6-1.5-.9-.3-.2-.5-.5-.6-.8-.1-.4 0-.7.1-1.1zm2.5-1c-.8 0-1.5.7-1.5 1.5s.7 1.5 1.5 1.5 1.5-.7 1.5-1.5-.7-1.5-1.5-1.5z" /><path d="M9.4 16.5c-.5-.1-.9-.3-1.3-.6-1.2-.8-1.9-2.1-1.9-3.5 0-1.2.6-2.3 1.6-3 .3-.2.6-.4.9-.5 1.1-.5 2.3-.3 3.3.4.4.3.8.7 1.1 1.1.3.4.5.8.6 1.3.1.5.1 1-.1 1.5-.4 1.3-1.5 2.2-2.8 2.4-.6.1-1.1.1-1.7.1z" /></svg>} />
        </div>
      </div>
